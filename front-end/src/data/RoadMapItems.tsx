...
},
{
  ...
  stepNo: 2,
  description: 'We’re building the Surge NFT and partnering up with top Web3 organizations who support our mission.',
  additionalSteps: [
    'We want to make sure we provide our community with the best perks coming into the space.',
    'Our artist is working hard at making these NFTs the coolest they can be for people’s profile 🔥'
  ]
},
{
...
},
{
  title: 'Future Drops',
  stepNo: 7,
  description: 'Swag, future drops, other surprise partnerships on the works. The Surge team will continue to add perks for holders as time goes by. HODLing pays off 😛.',
  additionalSteps: []
},
{
  title: 'Surge Product',
  stepNo: 8,
  description: 'As a natural evolution of our jobs board, we are developing an innovative product that will make us the defacto space for onboarding and hiring women in Web3. Stay tuned! 👀',
  additionalSteps: []
},
];