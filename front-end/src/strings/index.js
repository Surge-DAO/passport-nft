export const STRINGS = {
  ...
  perks: 'Perks',
  pleaseConnectWallet: 'Connect your crypto wallet to mint up to 5 NFTs with ETH. You\'ll immediately have access to claim perks.',
  presaleOpens: 'Presale mint opens April 28th',
  publicSaleNotActive: 'Paying with credit card will be enabled only for public sale, starting April 30th, and will incur a 4.5% processing fee.',
  roadmap: 'Roadmap',
