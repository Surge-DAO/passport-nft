export const STRINGS = {
  ...
  errorBadAddress: 'Make sure your friend copy-pasted their address and sent it to you. Seems like the address is not a real one.',
  findYourTxn: 'You can find your transaction on Etherscan here',
  finishedAndMintingFriend: 'Finished minting yours? Gift to a friend',
  ...
  mintETH: 'Mint up to 5 NFTs and get immediate access to perks!',
  ...
  perks: 'Perks',
  pleaseConnectWallet: 'Connect your wallet to mint up to 5 NFTs with ETH.',
  presaleOpens: 'Presale mint opens April 28th',
  publicSaleNotActive: 'Paying with credit card will be enabled for public sale, starting April 30th.',
  roadmap: 'Roadmap',
