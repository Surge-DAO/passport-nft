export const STRINGS = {
  ...
  `,
  checkOutCollection: 'Check out our collection in OpenSea',
  clickToMint: 'Click to Mint',
  connectWallet: 'Connect Wallet',
  crossmintDisclaimer: 'Minting with credit card incurs a 4.5% fee and you will only be able to mint 1 at a time.',
  ...
  logOut: 'Log out',
  mintETH: 'Minting with ETH means you can mint up to 5 NFTs and grants immediate access to perks.',
  minting: 'minting?',
  ...
  perks: 'Perks',
  pleaseConnectWallet: 'Please connect your wallet first to be able to mint with ETH.',
  presaleOpens: 'Presale mint opens April 28th',
  publicSaleNotActive: 'Paying with credit card is only enabled for public sale, which starts on April 30th.',
  roadmap: 'Roadmap',
